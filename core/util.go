...
const (
	...
	NormalformatV2 = "20060102"
	NormalformatV3 = "01-02 15:04"
	LongYearsLater = int64(7258089600) // 2200-01-01 00:00:00
)
...
func AlarmEvent(srvName, toEmail, title, content string) {
	...
	auth := smtp.PlainAuth("", from.Address, "123456", host)
