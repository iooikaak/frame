...
const (
	consulKeyConn         consulKey = "consul_connect"
	consulKeyConfig       consulKey = "consul_config"
	consulKeyAllowState   consulKey = "consul_allow_stale"
	consulKeyQueryOptions consulKey = "consul_query_options"
	consulKeyTcpCheck     consulKey = "consul_tcp_check"
)
...
func Connect() registry.Option {
	return func(o *registry.Options) {
		...
		o.Context = context.WithValue(o.Context, consulKeyConn, true)
	}
}
...
func Config(c *consul.Config) registry.Option {
	return func(o *registry.Options) {
		...
		o.Context = context.WithValue(o.Context, consulKeyConfig, c)
	}
}
...
func AllowStale(v bool) registry.Option {
	return func(o *registry.Options) {
		...
		o.Context = context.WithValue(o.Context, consulKeyAllowState, v)
	}
}
...
func QueryOptions(q *consul.QueryOptions) registry.Option {
	return func(o *registry.Options) {
		...
		o.Context = context.WithValue(o.Context, consulKeyQueryOptions, q)
	}
}
...
func TCPCheck(t time.Duration) registry.Option {
	return func(o *registry.Options) {
		...
		o.Context = context.WithValue(o.Context, consulKeyTcpCheck, t)
	}
}
