...
func (c *consulRegistry) Deregister(s *registry.Service, r ...registry.DeregisterOption) error {
	if len(s.Nodes) == 0 {
...
func (c *consulRegistry) ListServices(l ...registry.ListOption) ([]*registry.Service, error) {
