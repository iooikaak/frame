...
func CORS(allowOriginHosts []string) gins.HandlerFunc {
	config := &CORSConfig{
...
func newCORS(config *CORSConfig) gins.HandlerFunc {
...
func (cors *cors) applyCORS(c *gins.Context) {
...
func (cors *cors) handlePreflight(c *gins.Context) {
	header := c.Writer.Header()
...
func (cors *cors) handleNormal(c *gins.Context) {
	header := c.Writer.Header()
