...
import (
	...
	"github.com/iooikaak/frame/net/http/blademaster/binding"
	"github.com/iooikaak/frame/net/http/blademaster/render"
...
func (c *Context) Render(code int, r render.Render) {
	...
	jsonp := cb != ""
	if jsonp {
		_, _ = c.Writer.Write([]byte(cb))
		_, _ = c.Writer.Write(_openParen)
	}
